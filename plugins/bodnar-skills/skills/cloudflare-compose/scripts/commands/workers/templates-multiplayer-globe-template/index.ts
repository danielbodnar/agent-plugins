/**
 * workers / templates-multiplayer-globe-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/multiplayer-globe-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/multiplayer-globe-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-multiplayer-globe-template           # print
 *   ./scripts/cli workers templates-multiplayer-globe-template --run     # execute
 *   ./scripts/cli workers templates-multiplayer-globe-template --json    # metadata
 *   ./scripts/cli workers templates-multiplayer-globe-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-multiplayer-globe-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/multiplayer-globe-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/multiplayer-globe-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/multiplayer-globe-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/multiplayer-globe-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/multiplayer-globe-template"
    }
  ],
} as const;
