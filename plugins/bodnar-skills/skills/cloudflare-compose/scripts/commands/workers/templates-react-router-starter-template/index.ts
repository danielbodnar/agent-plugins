/**
 * workers / templates-react-router-starter-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/react-router-starter-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/react-router-starter-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-react-router-starter-template           # print
 *   ./scripts/cli workers templates-react-router-starter-template --run     # execute
 *   ./scripts/cli workers templates-react-router-starter-template --json    # metadata
 *   ./scripts/cli workers templates-react-router-starter-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-react-router-starter-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/react-router-starter-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/react-router-starter-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/react-router-starter-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/react-router-starter-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/react-router-starter-template"
    }
  ],
} as const;
