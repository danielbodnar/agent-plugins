 ...
 *
 * Source page: Hono
 * Docs subpath: docs/workers/framework-guides/web-apps/nextjs.mdx
 * Default target dir: my-next-app
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-next-app --framework=next
 *   [yarn] yarn create cloudflare my-next-app --framework=next
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-next-app           # print
 *   ./scripts/cli workers my-next-app --run     # execute
 *   ./scripts/cli workers my-next-app --json    # metadata
 *   ./scripts/cli workers my-next-app --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "my-next-app",
  description: "[ Edit page ](https://github.com/cloudflare/cloudflare-docs/edit/production/src/content/docs/workers/framework-guides/web-apps/nextjs.mdx) [ Report issue ](https://github.com/cloudflare/cloudflare-docs/issues/new/choose)",
  page_title: "Hono",
  template_id: null,
  target_dir: "my-next-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-next-app --framework=next",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-next-app --framework=next"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-next-app --framework=next"
    }
  ],
} as const;
