/**
 * workers / my-astro-app
 *
 * Source page: Astro
 * Docs subpath: docs/workers/framework-guides/web-apps/astro.mdx
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-astro-app --framework=astro
 *   [yarn] yarn create cloudflare my-astro-app --framework=astro
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-astro-app           # print
 *   ./scripts/cli workers my-astro-app --run     # execute
 *   ./scripts/cli workers my-astro-app --json    # metadata
 *   ./scripts/cli workers my-astro-app --target-dir=my-project
 *
...
export const meta = {
  ...
  description: "[ Edit page ](https://github.com/cloudflare/cloudflare-docs/edit/production/src/content/docs/workers/framework-guides/web-apps/astro.mdx) [ Report issue ](https://github.com/cloudflare/cloudflare-docs/issues/new/choose)",
  page_title: "Astro",
  template_id: null,
  target_dir: "my-astro-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-astro-app --framework=astro",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-astro-app --framework=astro"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-astro-app --framework=astro"
    }
  ],
} as const;
