 ...
 *
 * Source page: Hono
 * Docs subpath: docs/workers/framework-guides/web-apps/more-web-frameworks/qwik.mdx
 * Default target dir: my-qwik-app
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-qwik-app --framework=qwik
 *   [yarn] yarn create cloudflare my-qwik-app --framework=qwik
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-qwik-app           # print
 *   ./scripts/cli workers my-qwik-app --run     # execute
 *   ./scripts/cli workers my-qwik-app --json    # metadata
 *   ./scripts/cli workers my-qwik-app --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "my-qwik-app",
  description: "In this guide, you will create a new [Qwik ↗](https://qwik.dev/) application and deploy to Cloudflare Workers (with the new [Workers Assets](https://developers.cloudflare.com/workers/static-assets/)).",
  page_title: "Hono",
  template_id: null,
  target_dir: "my-qwik-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-qwik-app --framework=qwik",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-qwik-app --framework=qwik"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-qwik-app --framework=qwik"
    }
  ],
} as const;
