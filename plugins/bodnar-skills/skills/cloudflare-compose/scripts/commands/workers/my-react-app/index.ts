/**
 * workers / my-react-app
 *
 * Source page: React + Vite
 * Docs subpath: docs/workers/static-assets/index.mdx
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-react-app --framework=react
 *   [yarn] yarn create cloudflare my-react-app --framework=react
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-react-app           # print
 *   ./scripts/cli workers my-react-app --run     # execute
 *   ./scripts/cli workers my-react-app --json    # metadata
 *   ./scripts/cli workers my-react-app --target-dir=my-project
 *
...
export const meta = {
  ...
  description: "[ Edit page ](https://github.com/cloudflare/cloudflare-docs/edit/production/src/content/docs/workers/static-assets/index.mdx) [ Report issue ](https://github.com/cloudflare/cloudflare-docs/issues/new/choose)",
  page_title: "React + Vite",
  template_id: null,
  target_dir: "my-react-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-react-app --framework=react",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-react-app --framework=react"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-react-app --framework=react"
    }
  ],
} as const;
