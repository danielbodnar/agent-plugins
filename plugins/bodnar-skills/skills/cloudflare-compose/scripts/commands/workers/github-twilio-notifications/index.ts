/**
 * workers / github-twilio-notifications
 *
 * Source page: GitHub SMS notifications using Twilio
 * Docs subpath: docs/workers/tutorials/github-sms-notifications-using-twilio.mdx
 * Default target dir: github-twilio-notifications
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest github-twilio-notifications
 *   [yarn] yarn create cloudflare github-twilio-notifications
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers github-twilio-notifications           # print
 *   ./scripts/cli workers github-twilio-notifications --run     # execute
 *   ./scripts/cli workers github-twilio-notifications --json    # metadata
 *   ./scripts/cli workers github-twilio-notifications --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "github-twilio-notifications",
  description: "![Animated gif of receiving a text message on your phone after pushing changes to a repository](https://developers.cloudflare.com/images/workers/tutorials/github-sms/video-of-receiving-a-text-after-pushing-to-a-repo.gif)",
  page_title: "GitHub SMS notifications using Twilio",
  template_id: null,
  target_dir: "github-twilio-notifications",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- github-twilio-notifications",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest github-twilio-notifications"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare github-twilio-notifications"
    }
  ],
} as const;
