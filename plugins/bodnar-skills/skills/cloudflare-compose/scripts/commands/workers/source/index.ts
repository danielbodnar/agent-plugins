 ...
 *   ./scripts/cli workers source           # print
 *   ./scripts/cli workers source --run     # execute
 *   ./scripts/cli workers source --json    # metadata
 *   ./scripts/cli workers source --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "source",
  description: "In addition to creating new projects from C3 templates, C3 also supports creating new projects from existing Git repositories. To create a new project from an existing Git repository, open your terminal and run:",
  page_title: "CLI",
  template_id: "<SOURCE>",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template <SOURCE>",
  alternates: [],
} as const;
