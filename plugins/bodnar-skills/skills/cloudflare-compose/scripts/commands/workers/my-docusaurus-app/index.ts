/**
 * workers / my-docusaurus-app
 *
 * Source page: Docusaurus
 * Docs subpath: docs/workers/framework-guides/web-apps/more-web-frameworks/docusaurus.mdx
 * Default target dir: my-docusaurus-app
 *
 ...
 *
 * Alternate runtimes:
 *   [npm] npm create cloudflare@latest -- my-docusaurus-app --framework=docusaurus --platform=workers
 *   [pnpm] pnpm create cloudflare@latest my-docusaurus-app --framework=docusaurus
 *   [pnpm] pnpm create cloudflare@latest my-docusaurus-app --framework=docusaurus --platform=workers
 *   [yarn] yarn create cloudflare my-docusaurus-app --framework=docusaurus
 *   [yarn] yarn create cloudflare my-docusaurus-app --framework=docusaurus --platform=workers
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-docusaurus-app           # print
 *   ./scripts/cli workers my-docusaurus-app --run     # execute
 *   ./scripts/cli workers my-docusaurus-app --json    # metadata
 *   ./scripts/cli workers my-docusaurus-app --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "my-docusaurus-app",
  description: "[ Edit page ](https://github.com/cloudflare/cloudflare-docs/edit/production/src/content/docs/workers/framework-guides/web-apps/more-web-frameworks/docusaurus.mdx) [ Report issue ](https://github.com/cloudflare/cloudflare-docs/issues/new/choose)",
  page_title: "Docusaurus",
  template_id: null,
  target_dir: "my-docusaurus-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-docusaurus-app --framework=docusaurus",
  alternates: [
    {
      "runtime": "npm",
      "command": "npm create cloudflare@latest -- my-docusaurus-app --framework=docusaurus --platform=workers"
    },
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-docusaurus-app --framework=docusaurus"
    },
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-docusaurus-app --framework=docusaurus --platform=workers"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-docusaurus-app --framework=docusaurus"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-docusaurus-app --framework=docusaurus --platform=workers"
    }
  ],
} as const;
