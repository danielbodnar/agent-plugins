 ...
 *
 * Source page: Hono
 * Docs subpath: docs/workers/framework-guides/web-apps/more-web-frameworks/waku.mdx
 * Default target dir: my-waku-app
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-waku-app --framework=waku
 *   [yarn] yarn create cloudflare@latest my-waku-app --framework=waku
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-waku-app           # print
 *   ./scripts/cli workers my-waku-app --run     # execute
 *   ./scripts/cli workers my-waku-app --json    # metadata
 *   ./scripts/cli workers my-waku-app --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "my-waku-app",
  description: "",
  page_title: "Hono",
  template_id: null,
  target_dir: "my-waku-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest my-waku-app -- --framework=waku",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-waku-app --framework=waku"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare@latest my-waku-app --framework=waku"
    }
  ],
} as const;
