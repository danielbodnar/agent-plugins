/**
 * workers / templates-saas-admin-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/saas-admin-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/saas-admin-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/saas-admin-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-saas-admin-template           # print
 *   ./scripts/cli workers templates-saas-admin-template --run     # execute
 *   ./scripts/cli workers templates-saas-admin-template --json    # metadata
 *   ./scripts/cli workers templates-saas-admin-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-saas-admin-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/saas-admin-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/saas-admin-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/saas-admin-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/saas-admin-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/saas-admin-template"
    }
  ],
} as const;
