/**
 * workers / mysql-tutorial
 *
 * Source page: Connect to a MySQL database with Cloudflare Workers
 * Docs subpath: docs/workers/tutorials/mysql.mdx
 * Default target dir: mysql-tutorial
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest mysql-tutorial
 *   [yarn] yarn create cloudflare mysql-tutorial
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers mysql-tutorial           # print
 *   ./scripts/cli workers mysql-tutorial --run     # execute
 *   ./scripts/cli workers mysql-tutorial --json    # metadata
 *   ./scripts/cli workers mysql-tutorial --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "mysql-tutorial",
  description: "",
  page_title: "Connect to a MySQL database with Cloudflare Workers",
  template_id: null,
  target_dir: "mysql-tutorial",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- mysql-tutorial",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest mysql-tutorial"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare mysql-tutorial"
    }
  ],
} as const;
