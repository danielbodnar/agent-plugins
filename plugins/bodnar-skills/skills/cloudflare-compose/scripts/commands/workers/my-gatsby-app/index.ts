/**
 * workers / my-gatsby-app
 *
 * Source page: Docusaurus
 * Docs subpath: docs/workers/framework-guides/web-apps/more-web-frameworks/gatsby.mdx
 * Default target dir: my-gatsby-app
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-gatsby-app --framework=gatsby
 *   [yarn] yarn create cloudflare my-gatsby-app --framework=gatsby
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-gatsby-app           # print
 *   ./scripts/cli workers my-gatsby-app --run     # execute
 *   ./scripts/cli workers my-gatsby-app --json    # metadata
 *   ./scripts/cli workers my-gatsby-app --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "my-gatsby-app",
  description: "In this guide, you will create a new [Gatsby ↗](https://www.gatsbyjs.com/) application and deploy to Cloudflare Workers (with the new [Workers Assets](https://developers.cloudflare.com/workers/static-assets/)).",
  page_title: "Docusaurus",
  template_id: null,
  target_dir: "my-gatsby-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-gatsby-app --framework=gatsby",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-gatsby-app --framework=gatsby"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-gatsby-app --framework=gatsby"
    }
  ],
} as const;
