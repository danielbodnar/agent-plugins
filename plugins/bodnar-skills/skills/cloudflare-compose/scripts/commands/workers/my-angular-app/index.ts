/**
 * workers / my-angular-app
 *
 * Source page: Angular
 * Docs subpath: docs/workers/framework-guides/web-apps/more-web-frameworks/angular.mdx
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-angular-app --framework=angular
 *   [yarn] yarn create cloudflare my-angular-app --framework=angular
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-angular-app           # print
 *   ./scripts/cli workers my-angular-app --run     # execute
 *   ./scripts/cli workers my-angular-app --json    # metadata
 *   ./scripts/cli workers my-angular-app --target-dir=my-project
 *
...
export const meta = {
  ...
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-angular-app --framework=angular",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-angular-app --framework=angular"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-angular-app --framework=angular"
    }
  ],
} as const;
