 ...
 * Docs subpath: docs/workers/tutorials/handle-form-submissions-with-airtable.mdx
 * Default target dir: airtable-form-handler
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest airtable-form-handler
 *   [yarn] yarn create cloudflare airtable-form-handler
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers airtable-form-handler           # print
 *   ./scripts/cli workers airtable-form-handler --run     # execute
 *   ./scripts/cli workers airtable-form-handler --json    # metadata
 *   ./scripts/cli workers airtable-form-handler --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "airtable-form-handler",
  description: "To handle the form submission, create and deploy a Worker that parses the incoming form data and prepares it for submission to Airtable.",
  page_title: "GitHub SMS notifications using Twilio",
  template_id: null,
  target_dir: "airtable-form-handler",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- airtable-form-handler",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest airtable-form-handler"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare airtable-form-handler"
    }
  ],
} as const;
