/**
 * workers / templates-next-starter-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/next-starter-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/next-starter-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/next-starter-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-next-starter-template           # print
 *   ./scripts/cli workers templates-next-starter-template --run     # execute
 *   ./scripts/cli workers templates-next-starter-template --json    # metadata
 *   ./scripts/cli workers templates-next-starter-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-next-starter-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/next-starter-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/next-starter-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/next-starter-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/next-starter-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/next-starter-template"
    }
  ],
} as const;
