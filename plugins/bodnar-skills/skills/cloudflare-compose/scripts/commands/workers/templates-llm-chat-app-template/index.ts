/**
 * workers / templates-llm-chat-app-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/llm-chat-app-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/llm-chat-app-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/llm-chat-app-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-llm-chat-app-template           # print
 *   ./scripts/cli workers templates-llm-chat-app-template --run     # execute
 *   ./scripts/cli workers templates-llm-chat-app-template --json    # metadata
 *   ./scripts/cli workers templates-llm-chat-app-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-llm-chat-app-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/llm-chat-app-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/llm-chat-app-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/llm-chat-app-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/llm-chat-app-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/llm-chat-app-template"
    }
  ],
} as const;
