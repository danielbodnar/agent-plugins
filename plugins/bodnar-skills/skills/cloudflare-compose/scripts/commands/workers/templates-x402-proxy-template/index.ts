/**
 * workers / templates-x402-proxy-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/x402-proxy-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/x402-proxy-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/x402-proxy-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-x402-proxy-template           # print
 *   ./scripts/cli workers templates-x402-proxy-template --run     # execute
 *   ./scripts/cli workers templates-x402-proxy-template --json    # metadata
 *   ./scripts/cli workers templates-x402-proxy-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-x402-proxy-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/x402-proxy-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/x402-proxy-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/x402-proxy-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/x402-proxy-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/x402-proxy-template"
    }
  ],
} as const;
