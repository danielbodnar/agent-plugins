 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/cli
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/cli
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-cli           # print
 *   ./scripts/cli workers templates-cli --run     # execute
 *   ./scripts/cli workers templates-cli --json    # metadata
 *   ./scripts/cli workers templates-cli --target-dir=my-project
 *
...
export const meta = {
  ...
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cli)",
  page_title: "Templates",
  template_id: "cloudflare/templates/cli",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/cli",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/cli"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/cli"
    }
  ],
} as const;
