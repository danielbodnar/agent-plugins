/**
 * workers / templates-postgres-hyperdrive-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/postgres-hyperdrive-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/postgres-hyperdrive-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/postgres-hyperdrive-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-postgres-hyperdrive-template           # print
 *   ./scripts/cli workers templates-postgres-hyperdrive-template --run     # execute
 *   ./scripts/cli workers templates-postgres-hyperdrive-template --json    # metadata
 *   ./scripts/cli workers templates-postgres-hyperdrive-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-postgres-hyperdrive-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/postgres-hyperdrive-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/postgres-hyperdrive-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/postgres-hyperdrive-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/postgres-hyperdrive-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/postgres-hyperdrive-template"
    }
  ],
} as const;
