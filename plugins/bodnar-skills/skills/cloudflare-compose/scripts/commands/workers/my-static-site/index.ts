 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-static-site
 *   [yarn] yarn create cloudflare my-static-site
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-static-site           # print
 *   ./scripts/cli workers my-static-site --run     # execute
 *   ./scripts/cli workers my-static-site --json    # metadata
 *   ./scripts/cli workers my-static-site --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "my-static-site",
  description: "This guide will instruct you through setting up and deploying a static site or a full-stack application without a framework on Workers.",
  page_title: "Get Started",
  template_id: null,
  target_dir: "my-static-site",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-static-site",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-static-site"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-static-site"
    }
  ],
} as const;
