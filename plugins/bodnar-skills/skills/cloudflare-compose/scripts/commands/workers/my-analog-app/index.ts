/**
 * workers / my-analog-app
 *
 * Source page: Analog
 * Docs subpath: docs/workers/framework-guides/web-apps/more-web-frameworks/analog.mdx
 * Default target dir: my-analog-app
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-analog-app --framework=analog
 *   [yarn] yarn create cloudflare my-analog-app --framework=analog
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-analog-app           # print
 *   ./scripts/cli workers my-analog-app --run     # execute
 *   ./scripts/cli workers my-analog-app --json    # metadata
 *   ./scripts/cli workers my-analog-app --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "my-analog-app",
  description: "",
  page_title: "Analog",
  template_id: null,
  target_dir: "my-analog-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-analog-app --framework=analog",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-analog-app --framework=analog"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-analog-app --framework=analog"
    }
  ],
} as const;
