/**
 * workers / templates-react-router-postgres-ssr-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/react-router-postgres-ssr-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/react-router-postgres-ssr-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/react-router-postgres-ssr-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-react-router-postgres-ssr-template           # print
 *   ./scripts/cli workers templates-react-router-postgres-ssr-template --run     # execute
 *   ./scripts/cli workers templates-react-router-postgres-ssr-template --json    # metadata
 *   ./scripts/cli workers templates-react-router-postgres-ssr-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-react-router-postgres-ssr-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/react-router-postgres-ssr-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/react-router-postgres-ssr-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/react-router-postgres-ssr-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/react-router-postgres-ssr-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/react-router-postgres-ssr-template"
    }
  ],
} as const;
