/**
 * workers / templates-remix-starter-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/remix-starter-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/remix-starter-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/remix-starter-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-remix-starter-template           # print
 *   ./scripts/cli workers templates-remix-starter-template --run     # execute
 *   ./scripts/cli workers templates-remix-starter-template --json    # metadata
 *   ./scripts/cli workers templates-remix-starter-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-remix-starter-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/remix-starter-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/remix-starter-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/remix-starter-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/remix-starter-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/remix-starter-template"
    }
  ],
} as const;
