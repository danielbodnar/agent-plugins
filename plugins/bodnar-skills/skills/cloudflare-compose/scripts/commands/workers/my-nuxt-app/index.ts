 ...
 *
 * Source page: Hono
 * Docs subpath: docs/workers/framework-guides/web-apps/more-web-frameworks/nuxt.mdx
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-nuxt-app --framework=nuxt
 *   [yarn] yarn create cloudflare my-nuxt-app --framework=nuxt
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-nuxt-app           # print
 *   ./scripts/cli workers my-nuxt-app --run     # execute
 *   ./scripts/cli workers my-nuxt-app --json    # metadata
 *   ./scripts/cli workers my-nuxt-app --target-dir=my-project
 *
...
export const meta = {
  ...
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-nuxt-app --framework=nuxt",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-nuxt-app --framework=nuxt"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-nuxt-app --framework=nuxt"
    }
  ],
} as const;
