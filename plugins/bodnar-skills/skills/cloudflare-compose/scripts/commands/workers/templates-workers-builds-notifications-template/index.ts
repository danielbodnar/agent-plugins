/**
 * workers / templates-workers-builds-notifications-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/workers-builds-notifications-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/workers-builds-notifications-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/workers-builds-notifications-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-workers-builds-notifications-template           # print
 *   ./scripts/cli workers templates-workers-builds-notifications-template --run     # execute
 *   ./scripts/cli workers templates-workers-builds-notifications-template --json    # metadata
 *   ./scripts/cli workers templates-workers-builds-notifications-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-workers-builds-notifications-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/workers-builds-notifications-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/workers-builds-notifications-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/workers-builds-notifications-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/workers-builds-notifications-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/workers-builds-notifications-template"
    }
  ],
} as const;
