/**
 * workers / qr-code-generator
 *
 * Source page: Build a QR code generator
 * Docs subpath: docs/workers/tutorials/build-a-qr-code-generator.mdx
 * Default target dir: qr-code-generator
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest qr-code-generator
 *   [yarn] yarn create cloudflare qr-code-generator
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers qr-code-generator           # print
 *   ./scripts/cli workers qr-code-generator --run     # execute
 *   ./scripts/cli workers qr-code-generator --json    # metadata
 *   ./scripts/cli workers qr-code-generator --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "qr-code-generator",
  description: "In this tutorial, you will build and publish a Worker application that generates QR codes.",
  page_title: "Build a QR code generator",
  template_id: null,
  target_dir: "qr-code-generator",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- qr-code-generator",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest qr-code-generator"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare qr-code-generator"
    }
  ],
} as const;
