/**
 * workers / templates-mysql-hyperdrive-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/mysql-hyperdrive-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/mysql-hyperdrive-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/mysql-hyperdrive-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-mysql-hyperdrive-template           # print
 *   ./scripts/cli workers templates-mysql-hyperdrive-template --run     # execute
 *   ./scripts/cli workers templates-mysql-hyperdrive-template --json    # metadata
 *   ./scripts/cli workers templates-mysql-hyperdrive-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-mysql-hyperdrive-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mysql-hyperdrive-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/mysql-hyperdrive-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/mysql-hyperdrive-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/mysql-hyperdrive-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/mysql-hyperdrive-template"
    }
  ],
} as const;
