/**
 * workers / templates-microfrontend-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/microfrontend-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/microfrontend-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/microfrontend-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-microfrontend-template           # print
 *   ./scripts/cli workers templates-microfrontend-template --run     # execute
 *   ./scripts/cli workers templates-microfrontend-template --json    # metadata
 *   ./scripts/cli workers templates-microfrontend-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-microfrontend-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/microfrontend-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/microfrontend-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/microfrontend-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/microfrontend-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/microfrontend-template"
    }
  ],
} as const;
