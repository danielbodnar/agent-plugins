/**
 * workers / templates-chanfana-openapi-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/chanfana-openapi-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/chanfana-openapi-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/chanfana-openapi-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-chanfana-openapi-template           # print
 *   ./scripts/cli workers templates-chanfana-openapi-template --run     # execute
 *   ./scripts/cli workers templates-chanfana-openapi-template --json    # metadata
 *   ./scripts/cli workers templates-chanfana-openapi-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-chanfana-openapi-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/chanfana-openapi-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/chanfana-openapi-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/chanfana-openapi-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/chanfana-openapi-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/chanfana-openapi-template"
    }
  ],
} as const;
