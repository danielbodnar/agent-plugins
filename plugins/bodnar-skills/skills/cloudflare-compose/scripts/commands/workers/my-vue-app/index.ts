 ...
 *
 * Source page: Vike
 * Docs subpath: docs/workers/framework-guides/web-apps/vue.mdx
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-vue-app --framework=vue
 *   [yarn] yarn create cloudflare my-vue-app --framework=vue
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-vue-app           # print
 *   ./scripts/cli workers my-vue-app --run     # execute
 *   ./scripts/cli workers my-vue-app --json    # metadata
 *   ./scripts/cli workers my-vue-app --target-dir=my-project
 *
...
export const meta = {
  ...
  description: "In this guide, you will create a new [Vue ↗](https://vuejs.org/) application and deploy to Cloudflare Workers (with the new [Workers Assets](https://developers.cloudflare.com/workers/static-assets/)).",
  page_title: "Vike",
  template_id: null,
  target_dir: "my-vue-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-vue-app --framework=vue",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-vue-app --framework=vue"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-vue-app --framework=vue"
    }
  ],
} as const;
