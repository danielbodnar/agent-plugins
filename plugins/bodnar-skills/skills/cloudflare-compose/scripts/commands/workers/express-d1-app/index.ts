/**
 * workers / express-d1-app
 *
 * Source page: Deploy an Express.js application on Cloudflare Workers
 * Docs subpath: docs/workers/tutorials/deploy-an-express-app.mdx
 * Default target dir: express-d1-app
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest express-d1-app
 *   [yarn] yarn create cloudflare express-d1-app
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers express-d1-app           # print
 *   ./scripts/cli workers express-d1-app --run     # execute
 *   ./scripts/cli workers express-d1-app --json    # metadata
 *   ./scripts/cli workers express-d1-app --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "express-d1-app",
  description: "If you want to skip the steps and get started quickly, select **Deploy to Cloudflare** below.",
  page_title: "Deploy an Express.js application on Cloudflare Workers",
  template_id: null,
  target_dir: "express-d1-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- express-d1-app",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest express-d1-app"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare express-d1-app"
    }
  ],
} as const;
