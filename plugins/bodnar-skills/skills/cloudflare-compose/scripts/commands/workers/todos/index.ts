 ...
 * Docs subpath: docs/workers/tutorials/build-a-jamstack-app.mdx
 * Default target dir: todos
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest todos
 *   [yarn] yarn create cloudflare todos
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers todos           # print
 *   ./scripts/cli workers todos --run     # execute
 *   ./scripts/cli workers todos --json    # metadata
 *   ./scripts/cli workers todos --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "todos",
  description: "If you would like to see the finished code for this project, find the [project on GitHub ↗](https://github.com/lauragift21/cloudflare-workers-todos) and refer to the [live demo ↗](https://todos.examples.workers.dev/) to review what you will be building.",
  page_title: "Tutorials",
  template_id: null,
  target_dir: "todos",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- todos",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest todos"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare todos"
    }
  ],
} as const;
