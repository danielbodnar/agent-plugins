/**
 * workers / my-react-router-app
 *
 * Source page: React + Vite
 * Docs subpath: docs/workers/framework-guides/web-apps/react-router.mdx
 * Default target dir: my-react-router-app
 *
 ...
 *   ./scripts/cli workers my-react-router-app           # print
 *   ./scripts/cli workers my-react-router-app --run     # execute
 *   ./scripts/cli workers my-react-router-app --json    # metadata
 *   ./scripts/cli workers my-react-router-app --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "my-react-router-app",
  description: "[ Edit page ](https://github.com/cloudflare/cloudflare-docs/edit/production/src/content/docs/workers/framework-guides/web-apps/react-router.mdx) [ Report issue ](https://github.com/cloudflare/cloudflare-docs/issues/new/choose)",
  page_title: "React + Vite",
  template_id: null,
  target_dir: "my-react-router-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-react-router-app --framework=react-router",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-react-router-app --framework=react-router"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-react-router-app --framework=react-router"
    }
  ],
} as const;
