/**
 * workers / templates-containers-template
 *
 ...
 *   ./scripts/cli workers templates-containers-template           # print
 *   ./scripts/cli workers templates-containers-template --run     # execute
 *   ./scripts/cli workers templates-containers-template --json    # metadata
 *   ./scripts/cli workers templates-containers-template --target-dir=my-project
 *
...
export const meta = {
  ...
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/containers-template)",
