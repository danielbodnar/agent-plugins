/**
 * workers / my-solid-app
 *
 * Source page: Hono
 * Docs subpath: docs/workers/framework-guides/web-apps/more-web-frameworks/solid.mdx
 * Default target dir: my-solid-app
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-solid-app --framework=solid --experimental
 *   [yarn] yarn create cloudflare my-solid-app --framework=solid --experimental
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-solid-app           # print
 *   ./scripts/cli workers my-solid-app --run     # execute
 *   ./scripts/cli workers my-solid-app --json    # metadata
 *   ./scripts/cli workers my-solid-app --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "my-solid-app",
  description: "In this guide, you will create a new [Solid ↗](https://www.solidjs.com/) application and deploy to Cloudflare Workers (with the new [Workers Assets](https://developers.cloudflare.com/workers/static-assets/)).",
  page_title: "Hono",
  template_id: null,
  target_dir: "my-solid-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-solid-app --framework=solid --experimental",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-solid-app --framework=solid --experimental"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-solid-app --framework=solid --experimental"
    }
  ],
} as const;
