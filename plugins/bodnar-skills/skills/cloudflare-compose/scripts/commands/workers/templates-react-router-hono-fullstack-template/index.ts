/**
 * workers / templates-react-router-hono-fullstack-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/react-router-hono-fullstack-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/react-router-hono-fullstack-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/react-router-hono-fullstack-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-react-router-hono-fullstack-template           # print
 *   ./scripts/cli workers templates-react-router-hono-fullstack-template --run     # execute
 *   ./scripts/cli workers templates-react-router-hono-fullstack-template --json    # metadata
 *   ./scripts/cli workers templates-react-router-hono-fullstack-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-react-router-hono-fullstack-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/react-router-hono-fullstack-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/react-router-hono-fullstack-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/react-router-hono-fullstack-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/react-router-hono-fullstack-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/react-router-hono-fullstack-template"
    }
  ],
} as const;
