/**
 * workers / templates-vite-react-template
 *
 * Source page: Hono
 * Docs subpath: docs/workers/framework-guides/web-apps/more-web-frameworks/hono.mdx
 * Template: cloudflare/templates/vite-react-template
 * Default target dir: my-hono-app
 *
 ...
 *
 * Alternate runtimes:
 *   [npm] npm create cloudflare@latest -- --template=cloudflare/templates/vite-react-template
 *   [pnpm] pnpm create cloudflare@latest my-hono-app --template=cloudflare/templates/vite-react-template
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/vite-react-template
 *   [yarn] yarn create cloudflare my-hono-app --template=cloudflare/templates/vite-react-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/vite-react-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-vite-react-template           # print
 *   ./scripts/cli workers templates-vite-react-template --run     # execute
 *   ./scripts/cli workers templates-vite-react-template --json    # metadata
 *   ./scripts/cli workers templates-vite-react-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-vite-react-template",
  description: "[ Edit page ](https://github.com/cloudflare/cloudflare-docs/edit/production/src/content/docs/workers/framework-guides/web-apps/more-web-frameworks/hono.mdx) [ Report issue ](https://github.com/cloudflare/cloudflare-docs/issues/new/choose)",
  page_title: "Hono",
  template_id: "cloudflare/templates/vite-react-template",
  target_dir: "my-hono-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-hono-app --template=cloudflare/templates/vite-react-template",
  alternates: [
    {
      "runtime": "npm",
      "command": "npm create cloudflare@latest -- --template=cloudflare/templates/vite-react-template"
    },
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-hono-app --template=cloudflare/templates/vite-react-template"
    },
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/vite-react-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-hono-app --template=cloudflare/templates/vite-react-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/vite-react-template"
    }
  ],
} as const;
