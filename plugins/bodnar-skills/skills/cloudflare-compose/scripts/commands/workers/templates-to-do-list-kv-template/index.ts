/**
 * workers / templates-to-do-list-kv-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/to-do-list-kv-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/to-do-list-kv-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/to-do-list-kv-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-to-do-list-kv-template           # print
 *   ./scripts/cli workers templates-to-do-list-kv-template --run     # execute
 *   ./scripts/cli workers templates-to-do-list-kv-template --json    # metadata
 *   ./scripts/cli workers templates-to-do-list-kv-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-to-do-list-kv-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/to-do-list-kv-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/to-do-list-kv-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/to-do-list-kv-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/to-do-list-kv-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/to-do-list-kv-template"
    }
  ],
} as const;
