/**
 * workers / templates-nodejs-http-server-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/nodejs-http-server-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/nodejs-http-server-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/nodejs-http-server-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-nodejs-http-server-template           # print
 *   ./scripts/cli workers templates-nodejs-http-server-template --run     # execute
 *   ./scripts/cli workers templates-nodejs-http-server-template --json    # metadata
 *   ./scripts/cli workers templates-nodejs-http-server-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-nodejs-http-server-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/nodejs-http-server-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/nodejs-http-server-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/nodejs-http-server-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/nodejs-http-server-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/nodejs-http-server-template"
    }
  ],
} as const;
