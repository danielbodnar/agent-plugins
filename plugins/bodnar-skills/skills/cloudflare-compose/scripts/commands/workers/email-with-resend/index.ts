/**
 * workers / email-with-resend
 *
 * Source page: Send Emails With Postmark
 * Docs subpath: docs/workers/tutorials/send-emails-with-resend.mdx
 * Default target dir: email-with-resend
 *
 ...
 *   ./scripts/cli workers email-with-resend           # print
 *   ./scripts/cli workers email-with-resend --run     # execute
 *   ./scripts/cli workers email-with-resend --json    # metadata
 *   ./scripts/cli workers email-with-resend --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "email-with-resend",
  description: "Alternatively, you can use CLI arguments to speed things up:",
  page_title: "Send Emails With Postmark",
  template_id: null,
  target_dir: "email-with-resend",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest email-with-resend -- --type=hello-world --ts=false --git=true --deploy=false",
  alternates: [],
} as const;
