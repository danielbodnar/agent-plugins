/**
 * workers / templates-hello-world-do-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/hello-world-do-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/hello-world-do-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/hello-world-do-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-hello-world-do-template           # print
 *   ./scripts/cli workers templates-hello-world-do-template --run     # execute
 *   ./scripts/cli workers templates-hello-world-do-template --json    # metadata
 *   ./scripts/cli workers templates-hello-world-do-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-hello-world-do-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/hello-world-do-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/hello-world-do-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/hello-world-do-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/hello-world-do-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/hello-world-do-template"
    }
  ],
} as const;
