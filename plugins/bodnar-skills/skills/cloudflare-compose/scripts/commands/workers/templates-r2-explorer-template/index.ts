/**
 * workers / templates-r2-explorer-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/r2-explorer-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/r2-explorer-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/r2-explorer-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-r2-explorer-template           # print
 *   ./scripts/cli workers templates-r2-explorer-template --run     # execute
 *   ./scripts/cli workers templates-r2-explorer-template --json    # metadata
 *   ./scripts/cli workers templates-r2-explorer-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-r2-explorer-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/r2-explorer-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/r2-explorer-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/r2-explorer-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/r2-explorer-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/r2-explorer-template"
    }
  ],
} as const;
