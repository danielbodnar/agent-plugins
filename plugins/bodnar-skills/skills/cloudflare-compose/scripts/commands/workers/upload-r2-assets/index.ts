/**
 * workers / upload-r2-assets
 *
 * Source page: Securely access and upload assets with Cloudflare R2
 * Docs subpath: docs/workers/tutorials/upload-assets-with-r2.mdx
 * Default target dir: upload-r2-assets
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest upload-r2-assets
 *   [yarn] yarn create cloudflare upload-r2-assets
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers upload-r2-assets           # print
 *   ./scripts/cli workers upload-r2-assets --run     # execute
 *   ./scripts/cli workers upload-r2-assets --json    # metadata
 *   ./scripts/cli workers upload-r2-assets --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "upload-r2-assets",
  description: "",
  page_title: "Securely access and upload assets with Cloudflare R2",
  template_id: null,
  target_dir: "upload-r2-assets",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- upload-r2-assets",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest upload-r2-assets"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare upload-r2-assets"
    }
  ],
} as const;
