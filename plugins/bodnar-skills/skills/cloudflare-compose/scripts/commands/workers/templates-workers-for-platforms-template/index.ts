/**
 * workers / templates-workers-for-platforms-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/workers-for-platforms-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/workers-for-platforms-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/workers-for-platforms-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-workers-for-platforms-template           # print
 *   ./scripts/cli workers templates-workers-for-platforms-template --run     # execute
 *   ./scripts/cli workers templates-workers-for-platforms-template --json    # metadata
 *   ./scripts/cli workers templates-workers-for-platforms-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-workers-for-platforms-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/workers-for-platforms-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/workers-for-platforms-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/workers-for-platforms-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/workers-for-platforms-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/workers-for-platforms-template"
    }
  ],
} as const;
