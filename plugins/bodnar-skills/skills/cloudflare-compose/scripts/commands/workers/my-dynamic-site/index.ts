/**
 * workers / my-dynamic-site
 *
 * Source page: Get Started
 * Docs subpath: docs/workers/static-assets/get-started.mdx
 * Default target dir: my-dynamic-site
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-dynamic-site
 *   [yarn] yarn create cloudflare my-dynamic-site
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-dynamic-site           # print
 *   ./scripts/cli workers my-dynamic-site --run     # execute
 *   ./scripts/cli workers my-dynamic-site --json    # metadata
 *   ./scripts/cli workers my-dynamic-site --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "my-dynamic-site",
  description: "This guide will instruct you through setting up and deploying dynamic and interactive server-side rendered (SSR) applications on Cloudflare Workers.",
  page_title: "Get Started",
  template_id: null,
  target_dir: "my-dynamic-site",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-dynamic-site",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-dynamic-site"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-dynamic-site"
    }
  ],
} as const;
