/**
 * workers / templates-nlweb-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/nlweb-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/nlweb-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/nlweb-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-nlweb-template           # print
 *   ./scripts/cli workers templates-nlweb-template --run     # execute
 *   ./scripts/cli workers templates-nlweb-template --json    # metadata
 *   ./scripts/cli workers templates-nlweb-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-nlweb-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/nlweb-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/nlweb-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/nlweb-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/nlweb-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/nlweb-template"
    }
  ],
} as const;
