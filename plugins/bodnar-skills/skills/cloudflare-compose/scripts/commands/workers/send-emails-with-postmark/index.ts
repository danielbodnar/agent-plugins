 ...
 *   ./scripts/cli workers send-emails-with-postmark           # print
 *   ./scripts/cli workers send-emails-with-postmark --run     # execute
 *   ./scripts/cli workers send-emails-with-postmark --json    # metadata
 *   ./scripts/cli workers send-emails-with-postmark --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "send-emails-with-postmark",
  description: "Start by using [C3](https://developers.cloudflare.com/pages/get-started/c3/) to create a Worker project in the command line, then, answer the prompts:",
  page_title: "Send Emails With Postmark",
  template_id: null,
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest",
  alternates: [],
} as const;
