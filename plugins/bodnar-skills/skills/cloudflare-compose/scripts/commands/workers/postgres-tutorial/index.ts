/**
 * workers / postgres-tutorial
 *
 * Source page: Connect to a MySQL database with Cloudflare Workers
 * Docs subpath: docs/workers/tutorials/postgres.mdx
 * Default target dir: postgres-tutorial
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest postgres-tutorial
 *   [yarn] yarn create cloudflare postgres-tutorial
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers postgres-tutorial           # print
 *   ./scripts/cli workers postgres-tutorial --run     # execute
 *   ./scripts/cli workers postgres-tutorial --json    # metadata
 *   ./scripts/cli workers postgres-tutorial --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "postgres-tutorial",
  description: "",
  page_title: "Connect to a MySQL database with Cloudflare Workers",
  template_id: null,
  target_dir: "postgres-tutorial",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- postgres-tutorial",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest postgres-tutorial"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare postgres-tutorial"
    }
  ],
} as const;
