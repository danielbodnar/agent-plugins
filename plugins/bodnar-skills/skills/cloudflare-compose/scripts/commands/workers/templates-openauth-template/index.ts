/**
 * workers / templates-openauth-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/openauth-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/openauth-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/openauth-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-openauth-template           # print
 *   ./scripts/cli workers templates-openauth-template --run     # execute
 *   ./scripts/cli workers templates-openauth-template --json    # metadata
 *   ./scripts/cli workers templates-openauth-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-openauth-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/openauth-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/openauth-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/openauth-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/openauth-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/openauth-template"
    }
  ],
} as const;
