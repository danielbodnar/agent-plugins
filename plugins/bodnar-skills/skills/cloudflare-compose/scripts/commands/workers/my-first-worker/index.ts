 ...
 *
 * Source page: CLI
 * Docs subpath: docs/workers/get-started/guide.mdx
 * Default target dir: my-first-worker
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-first-worker
 *   [yarn] yarn create cloudflare my-first-worker
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-first-worker           # print
 *   ./scripts/cli workers my-first-worker --run     # execute
 *   ./scripts/cli workers my-first-worker --json    # metadata
 *   ./scripts/cli workers my-first-worker --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "my-first-worker",
  description: "",
  page_title: "CLI",
  template_id: null,
  target_dir: "my-first-worker",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-first-worker",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-first-worker"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-first-worker"
    }
  ],
} as const;
