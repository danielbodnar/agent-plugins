/**
 * workers / templates-astro-blog-starter-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/astro-blog-starter-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/astro-blog-starter-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-astro-blog-starter-template           # print
 *   ./scripts/cli workers templates-astro-blog-starter-template --run     # execute
 *   ./scripts/cli workers templates-astro-blog-starter-template --json    # metadata
 *   ./scripts/cli workers templates-astro-blog-starter-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-astro-blog-starter-template",
  description: "Templates are GitHub repositories that are designed to be a starting point for building a new Cloudflare Workers project. To start any of the projects below, run:",
  page_title: "Templates",
  template_id: "cloudflare/templates/astro-blog-starter-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/astro-blog-starter-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/astro-blog-starter-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/astro-blog-starter-template"
    }
  ],
} as const;
