/**
 * workers / my-tanstack-start-app
 *
 * Source page: RedwoodSDK
 * Docs subpath: docs/workers/framework-guides/web-apps/tanstack-start.mdx
 * Default target dir: my-tanstack-start-app
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-tanstack-start-app --framework=tanstack-start
 *   [yarn] yarn create cloudflare my-tanstack-start-app --framework=tanstack-start
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-tanstack-start-app           # print
 *   ./scripts/cli workers my-tanstack-start-app --run     # execute
 *   ./scripts/cli workers my-tanstack-start-app --json    # metadata
 *   ./scripts/cli workers my-tanstack-start-app --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "my-tanstack-start-app",
  description: "Create a TanStack Start application pre-configured for Cloudflare Workers:",
  page_title: "RedwoodSDK",
  template_id: null,
  target_dir: "my-tanstack-start-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-tanstack-start-app --framework=tanstack-start",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-tanstack-start-app --framework=tanstack-start"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-tanstack-start-app --framework=tanstack-start"
    }
  ],
} as const;
