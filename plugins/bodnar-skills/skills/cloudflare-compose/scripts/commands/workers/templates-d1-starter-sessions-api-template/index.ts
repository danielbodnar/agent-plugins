/**
 * workers / templates-d1-starter-sessions-api-template
 *
 * Source page: Templates
 * Docs subpath: docs/workers/get-started/quickstarts.mdx
 * Template: cloudflare/templates/d1-starter-sessions-api-template
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest --template=cloudflare/templates/d1-starter-sessions-api-template
 *   [yarn] yarn create cloudflare --template=cloudflare/templates/d1-starter-sessions-api-template
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers templates-d1-starter-sessions-api-template           # print
 *   ./scripts/cli workers templates-d1-starter-sessions-api-template --run     # execute
 *   ./scripts/cli workers templates-d1-starter-sessions-api-template --json    # metadata
 *   ./scripts/cli workers templates-d1-starter-sessions-api-template --target-dir=my-project
 *
...
export const meta = {
  product: "workers",
  subcommand: "templates-d1-starter-sessions-api-template",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/d1-starter-sessions-api-template)",
  page_title: "Templates",
  template_id: "cloudflare/templates/d1-starter-sessions-api-template",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template=cloudflare/templates/d1-starter-sessions-api-template",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template=cloudflare/templates/d1-starter-sessions-api-template"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template=cloudflare/templates/d1-starter-sessions-api-template"
    }
  ],
} as const;
