/**
 * workers / my-svelte-app
 *
 * Source page: RedwoodSDK
 * Docs subpath: docs/workers/framework-guides/web-apps/sveltekit.mdx
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-svelte-app --framework=svelte
 *   [yarn] yarn create cloudflare my-svelte-app --framework=svelte
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers my-svelte-app           # print
 *   ./scripts/cli workers my-svelte-app --run     # execute
 *   ./scripts/cli workers my-svelte-app --json    # metadata
 *   ./scripts/cli workers my-svelte-app --target-dir=my-project
 *
...
export const meta = {
  ...
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-svelte-app --framework=svelte",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-svelte-app --framework=svelte"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-svelte-app --framework=svelte"
    }
  ],
} as const;
