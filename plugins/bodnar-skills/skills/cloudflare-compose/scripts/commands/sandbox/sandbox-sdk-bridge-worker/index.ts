/**
 * sandbox / sandbox-sdk-bridge-worker
 *
 * Source page: Sandbox bridge
 * Docs subpath: docs/sandbox/tutorials/openai-agents.mdx
 * Template: cloudflare/sandbox-sdk/bridge/worker
 * Default target dir: sandbox-bridge
 *
 ...
 *   ./scripts/cli sandbox sandbox-sdk-bridge-worker           # print
 *   ./scripts/cli sandbox sandbox-sdk-bridge-worker --run     # execute
 *   ./scripts/cli sandbox sandbox-sdk-bridge-worker --json    # metadata
 *   ./scripts/cli sandbox sandbox-sdk-bridge-worker --target-dir=my-project
 *
...
export const meta = {
  product: "sandbox",
  subcommand: "sandbox-sdk-bridge-worker",
  description: "[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/sandbox-sdk/tree/main/bridge/worker)",
  page_title: "Sandbox bridge",
  template_id: "cloudflare/sandbox-sdk/bridge/worker",
  target_dir: "sandbox-bridge",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare sandbox-bridge --template=cloudflare/sandbox-sdk/bridge/worker",
  alternates: [],
} as const;
