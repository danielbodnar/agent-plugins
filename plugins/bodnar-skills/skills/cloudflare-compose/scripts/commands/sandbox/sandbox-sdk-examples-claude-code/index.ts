/**
 * sandbox / sandbox-sdk-examples-claude-code
 *
 * Source page: Automated testing pipeline
 * Docs subpath: docs/sandbox/tutorials/claude-code.mdx
 * Template: cloudflare/sandbox-sdk/examples/claude-code
 * Default target dir: claude-code-sandbox
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest claude-code-sandbox --template=cloudflare/sandbox-sdk/examples/claude-code
 *   [yarn] yarn create cloudflare claude-code-sandbox --template=cloudflare/sandbox-sdk/examples/claude-code
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli sandbox sandbox-sdk-examples-claude-code           # print
 *   ./scripts/cli sandbox sandbox-sdk-examples-claude-code --run     # execute
 *   ./scripts/cli sandbox sandbox-sdk-examples-claude-code --json    # metadata
 *   ./scripts/cli sandbox sandbox-sdk-examples-claude-code --target-dir=my-project
 *
...
export const meta = {
  product: "sandbox",
  subcommand: "sandbox-sdk-examples-claude-code",
  description: "",
  page_title: "Automated testing pipeline",
  template_id: "cloudflare/sandbox-sdk/examples/claude-code",
  target_dir: "claude-code-sandbox",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- claude-code-sandbox --template=cloudflare/sandbox-sdk/examples/claude-code",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest claude-code-sandbox --template=cloudflare/sandbox-sdk/examples/claude-code"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare claude-code-sandbox --template=cloudflare/sandbox-sdk/examples/claude-code"
    }
  ],
} as const;
