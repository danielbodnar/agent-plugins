/**
 * sandbox / sandbox-sdk-examples-code-interpreter
 *
 * Source page: Data persistence with R2
 * Docs subpath: docs/sandbox/tutorials/workers-ai-code-interpreter.mdx
 * Template: cloudflare/sandbox-sdk/examples/code-interpreter
 * Default target dir: workers-ai-interpreter
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest workers-ai-interpreter --template=cloudflare/sandbox-sdk/examples/code-interpreter
 *   [yarn] yarn create cloudflare workers-ai-interpreter --template=cloudflare/sandbox-sdk/examples/code-interpreter
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli sandbox sandbox-sdk-examples-code-interpreter           # print
 *   ./scripts/cli sandbox sandbox-sdk-examples-code-interpreter --run     # execute
 *   ./scripts/cli sandbox sandbox-sdk-examples-code-interpreter --json    # metadata
 *   ./scripts/cli sandbox sandbox-sdk-examples-code-interpreter --target-dir=my-project
 *
...
export const meta = {
  product: "sandbox",
  subcommand: "sandbox-sdk-examples-code-interpreter",
  description: "",
  page_title: "Data persistence with R2",
  template_id: "cloudflare/sandbox-sdk/examples/code-interpreter",
  target_dir: "workers-ai-interpreter",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- workers-ai-interpreter --template=cloudflare/sandbox-sdk/examples/code-interpreter",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest workers-ai-interpreter --template=cloudflare/sandbox-sdk/examples/code-interpreter"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare workers-ai-interpreter --template=cloudflare/sandbox-sdk/examples/code-interpreter"
    }
  ],
} as const;
