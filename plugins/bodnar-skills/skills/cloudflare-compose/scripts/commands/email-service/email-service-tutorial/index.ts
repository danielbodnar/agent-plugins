/**
 * email-service / email-service-tutorial
 *
 * Source page: Route emails
 * Docs subpath: docs/email-service/get-started/send-emails.mdx
 * Default target dir: email-service-tutorial
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest email-service-tutorial
 *   [yarn] yarn create cloudflare email-service-tutorial
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli email-service email-service-tutorial           # print
 *   ./scripts/cli email-service email-service-tutorial --run     # execute
 *   ./scripts/cli email-service email-service-tutorial --json    # metadata
 *   ./scripts/cli email-service email-service-tutorial --target-dir=my-project
 *
...
export const meta = {
  ...
  subcommand: "email-service-tutorial",
  description: "For more details, see the [REST API reference](https://developers.cloudflare.com/email-service/api/send-emails/rest-api/).",
  page_title: "Route emails",
  template_id: null,
  target_dir: "email-service-tutorial",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- email-service-tutorial",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest email-service-tutorial"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare email-service-tutorial"
    }
  ],
} as const;
