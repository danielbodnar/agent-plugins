/**
 * email-service / email-processor
 *
 * Source page: Route emails
 * Docs subpath: docs/email-service/get-started/route-emails.mdx
 * Default target dir: email-processor
 *
 ...
 *   ./scripts/cli email-service email-processor           # print
 *   ./scripts/cli email-service email-processor --run     # execute
 *   ./scripts/cli email-service email-processor --json    # metadata
 *   ./scripts/cli email-service email-processor --target-dir=my-project
 *
...
export const meta = {
  ...
  subcommand: "email-processor",
  description: "Use Workers to process emails with custom logic before forwarding or responding.",
  page_title: "Route emails",
  template_id: null,
  target_dir: "email-processor",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest email-processor",
  alternates: [],
} as const;
