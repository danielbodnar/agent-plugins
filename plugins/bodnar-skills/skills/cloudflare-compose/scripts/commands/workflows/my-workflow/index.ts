 ...
 * Docs subpath: docs/workflows/get-started/guide.mdx
 * Default target dir: my-workflow
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-workflow
 *   [yarn] yarn create cloudflare my-workflow
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workflows my-workflow           # print
 *   ./scripts/cli workflows my-workflow --run     # execute
 *   ./scripts/cli workflows my-workflow --json    # metadata
 *   ./scripts/cli workflows my-workflow --target-dir=my-project
 *
...
export const meta = {
  product: "workflows",
  subcommand: "my-workflow",
  description: "",
  page_title: "Build a Durable AI Agent",
  template_id: null,
  target_dir: "my-workflow",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-workflow",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-workflow"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-workflow"
    }
  ],
} as const;
