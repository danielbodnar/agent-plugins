/**
 * workflows / cloudflare-workflows-starter
 *
 ...
 * Default target dir: workflows-starter
 *
 ...
 *   ./scripts/cli workflows cloudflare-workflows-starter           # print
 *   ./scripts/cli workflows cloudflare-workflows-starter --run     # execute
 *   ./scripts/cli workflows cloudflare-workflows-starter --json    # metadata
 *   ./scripts/cli workflows cloudflare-workflows-starter --target-dir=my-project
 *
...
export const meta = {
  product: "workflows",
  subcommand: "cloudflare-workflows-starter",
  description: "The term \"Durable Execution\" is widely used to describe this programming model.",
  page_title: "Build a Durable AI Agent",
  template_id: "\"cloudflare/workflows-starter\"",
  target_dir: "workflows-starter",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest workflows-starter -- --template \"cloudflare/workflows-starter\"",
  alternates: [],
} as const;
