/**
 * durable-objects / seat-booking
 *
 * Source page: Tutorials
 * Docs subpath: docs/durable-objects/tutorials/build-a-seat-booking-app.mdx
 * Default target dir: seat-booking
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest seat-booking
 *   [yarn] yarn create cloudflare seat-booking
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli durable-objects seat-booking           # print
 *   ./scripts/cli durable-objects seat-booking --run     # execute
 *   ./scripts/cli durable-objects seat-booking --json    # metadata
 *   ./scripts/cli durable-objects seat-booking --target-dir=my-project
 *
...
export const meta = {
  ...
  subcommand: "seat-booking",
  description: "",
  page_title: "Tutorials",
  template_id: null,
  target_dir: "seat-booking",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- seat-booking",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest seat-booking"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare seat-booking"
    }
  ],
} as const;
