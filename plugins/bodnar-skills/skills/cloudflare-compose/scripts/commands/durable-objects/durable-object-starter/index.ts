/**
 * durable-objects / durable-object-starter
 *
 * Source page: SQL statements
 * Docs subpath: docs/durable-objects/get-started.mdx
 * Default target dir: durable-object-starter
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest durable-object-starter
 *   [yarn] yarn create cloudflare durable-object-starter
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli durable-objects durable-object-starter           # print
 *   ./scripts/cli durable-objects durable-object-starter --run     # execute
 *   ./scripts/cli durable-objects durable-object-starter --json    # metadata
 *   ./scripts/cli durable-objects durable-object-starter --target-dir=my-project
 *
...
export const meta = {
  ...
  subcommand: "durable-object-starter",
  description: "You will access your Durable Object from a [Worker](https://developers.cloudflare.com/workers/). Your Worker application is an interface to interact with your Durable Object.",
  page_title: "SQL statements",
  template_id: null,
  target_dir: "durable-object-starter",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- durable-object-starter",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest durable-object-starter"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare durable-object-starter"
    }
  ],
} as const;
