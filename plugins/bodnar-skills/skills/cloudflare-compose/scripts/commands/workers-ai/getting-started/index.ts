 ...
 * Docs subpath: docs/workers-ai/get-started/dashboard.mdx
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest [<DIRECTORY>] --type=pre-existing
 *   [yarn] yarn create cloudflare [<DIRECTORY>] --type=pre-existing
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers-ai getting-started           # print
 *   ./scripts/cli workers-ai getting-started --run     # execute
 *   ./scripts/cli workers-ai getting-started --json    # metadata
 *   ./scripts/cli workers-ai getting-started --target-dir=my-project
 *
...
export const meta = {
  product: "workers-ai",
  subcommand: "getting-started",
  description: "To develop more advanced applications or [implement tests](https://developers.cloudflare.com/workers/testing/), start working in the Wrangler CLI.",
  page_title: "Getting started",
  template_id: null,
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- [<DIRECTORY>] --type=pre-existing",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest [<DIRECTORY>] --type=pre-existing"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare [<DIRECTORY>] --type=pre-existing"
    }
  ],
} as const;
