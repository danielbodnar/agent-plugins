/**
 * workers-ai / llama-vision-tutorial
 *
 * Source page: Llama 3.2 11B Vision Instruct model on Cloudflare Workers AI
 * Docs subpath: docs/workers-ai/guides/tutorials/llama-vision-tutorial.mdx
 * Default target dir: llama-vision-tutorial
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest llama-vision-tutorial
 *   [yarn] yarn create cloudflare llama-vision-tutorial
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers-ai llama-vision-tutorial           # print
 *   ./scripts/cli workers-ai llama-vision-tutorial --run     # execute
 *   ./scripts/cli workers-ai llama-vision-tutorial --json    # metadata
 *   ./scripts/cli workers-ai llama-vision-tutorial --target-dir=my-project
 *
...
export const meta = {
  product: "workers-ai",
  subcommand: "llama-vision-tutorial",
  description: "Replace `$CLOUDFLARE_ACCOUNT_ID` and `$CLOUDFLARE_AUTH_TOKEN` with your actual account ID and token.",
  page_title: "Llama 3.2 11B Vision Instruct model on Cloudflare Workers AI",
  template_id: null,
  target_dir: "llama-vision-tutorial",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- llama-vision-tutorial",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest llama-vision-tutorial"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare llama-vision-tutorial"
    }
  ],
} as const;
