/**
 * workers-ai / whisper-tutorial
 *
 * Source page: Build a Retrieval Augmented Generation (RAG) AI
 * Docs subpath: docs/workers-ai/guides/tutorials/build-a-workers-ai-whisper-with-chunking.mdx
 * Default target dir: whisper-tutorial
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest whisper-tutorial
 *   [yarn] yarn create cloudflare whisper-tutorial
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers-ai whisper-tutorial           # print
 *   ./scripts/cli workers-ai whisper-tutorial --run     # execute
 *   ./scripts/cli workers-ai whisper-tutorial --json    # metadata
 *   ./scripts/cli workers-ai whisper-tutorial --target-dir=my-project
 *
...
export const meta = {
  product: "workers-ai",
  subcommand: "whisper-tutorial",
  description: "",
  page_title: "Build a Retrieval Augmented Generation (RAG) AI",
  template_id: null,
  target_dir: "whisper-tutorial",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- whisper-tutorial",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest whisper-tutorial"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare whisper-tutorial"
    }
  ],
} as const;
