 ...
 * Docs subpath: docs/workers-ai/get-started/workers-wrangler.mdx
 * Default target dir: hello-ai
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest hello-ai
 *   [yarn] yarn create cloudflare hello-ai
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers-ai hello-ai           # print
 *   ./scripts/cli workers-ai hello-ai --run     # execute
 *   ./scripts/cli workers-ai hello-ai --json    # metadata
 *   ./scripts/cli workers-ai hello-ai --target-dir=my-project
 *
...
export const meta = {
  ...
  target_dir: "hello-ai",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- hello-ai",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest hello-ai"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare hello-ai"
    }
  ],
} as const;
