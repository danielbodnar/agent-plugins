/**
 * workers-ai / rag-ai-tutorial
 *
 * Source page: Build a Retrieval Augmented Generation (RAG) AI
 * Docs subpath: docs/workers-ai/guides/tutorials/build-a-retrieval-augmented-generation-ai.mdx
 * Default target dir: rag-ai-tutorial
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest rag-ai-tutorial
 *   [yarn] yarn create cloudflare rag-ai-tutorial
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers-ai rag-ai-tutorial           # print
 *   ./scripts/cli workers-ai rag-ai-tutorial --run     # execute
 *   ./scripts/cli workers-ai rag-ai-tutorial --json    # metadata
 *   ./scripts/cli workers-ai rag-ai-tutorial --target-dir=my-project
 *
...
export const meta = {
  product: "workers-ai",
  subcommand: "rag-ai-tutorial",
  description: "Open a terminal window and run C3 to create your Worker project:",
  page_title: "Build a Retrieval Augmented Generation (RAG) AI",
  template_id: null,
  target_dir: "rag-ai-tutorial",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- rag-ai-tutorial",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest rag-ai-tutorial"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare rag-ai-tutorial"
    }
  ],
} as const;
