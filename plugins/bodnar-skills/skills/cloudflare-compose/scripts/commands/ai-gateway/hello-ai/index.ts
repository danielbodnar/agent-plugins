 ...
 * Docs subpath: docs/ai-gateway/integrations/aig-workers-ai-binding.mdx
 ...
 *   ./scripts/cli ai-gateway hello-ai           # print
 *   ./scripts/cli ai-gateway hello-ai --run     # execute
 *   ./scripts/cli ai-gateway hello-ai --json    # metadata
 *   ./scripts/cli ai-gateway hello-ai --target-dir=my-project
 *
