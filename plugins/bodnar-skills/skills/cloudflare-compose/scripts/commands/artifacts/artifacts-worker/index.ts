 ...
 *
 * Source page: REST API
 * Docs subpath: docs/artifacts/get-started/workers.mdx
 * Default target dir: artifacts-worker
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest artifacts-worker
 *   [yarn] yarn create cloudflare artifacts-worker
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli artifacts artifacts-worker           # print
 *   ./scripts/cli artifacts artifacts-worker --run     # execute
 *   ./scripts/cli artifacts artifacts-worker --json    # metadata
 *   ./scripts/cli artifacts artifacts-worker --target-dir=my-project
 *
...
export const meta = {
  product: "artifacts",
  subcommand: "artifacts-worker",
  description: "",
  page_title: "REST API",
  template_id: null,
  target_dir: "artifacts-worker",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- artifacts-worker",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest artifacts-worker"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare artifacts-worker"
    }
  ],
} as const;
