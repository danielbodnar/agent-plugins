/**
 * queues / queues-web-crawler
 *
 * Source page: Handle rate limits of external APIs
 * Docs subpath: docs/queues/tutorials/web-crawler-with-browser-run/index.mdx
 * Default target dir: queues-web-crawler
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest queues-web-crawler
 *   [yarn] yarn create cloudflare queues-web-crawler
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli queues queues-web-crawler           # print
 *   ./scripts/cli queues queues-web-crawler --run     # execute
 *   ./scripts/cli queues queues-web-crawler --json    # metadata
 *   ./scripts/cli queues queues-web-crawler --target-dir=my-project
 *
...
export const meta = {
  product: "queues",
  subcommand: "queues-web-crawler",
  description: "",
  page_title: "Handle rate limits of external APIs",
  template_id: null,
  target_dir: "queues-web-crawler",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- queues-web-crawler",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest queues-web-crawler"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare queues-web-crawler"
    }
  ],
} as const;
