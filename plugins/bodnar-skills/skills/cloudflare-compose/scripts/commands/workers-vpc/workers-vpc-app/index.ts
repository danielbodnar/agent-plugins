/**
 * workers-vpc / workers-vpc-app
 *
 * Source page: Get started
 * Docs subpath: docs/workers-vpc/get-started.mdx
 * Default target dir: workers-vpc-app
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest workers-vpc-app
 *   [yarn] yarn create cloudflare workers-vpc-app
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli workers-vpc workers-vpc-app           # print
 *   ./scripts/cli workers-vpc workers-vpc-app --run     # execute
 *   ./scripts/cli workers-vpc workers-vpc-app --json    # metadata
 *   ./scripts/cli workers-vpc workers-vpc-app --target-dir=my-project
 *
...
export const meta = {
  product: "workers-vpc",
  subcommand: "workers-vpc-app",
  description: "",
  page_title: "Get started",
  template_id: null,
  target_dir: "workers-vpc-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- workers-vpc-app",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest workers-vpc-app"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare workers-vpc-app"
    }
  ],
} as const;
