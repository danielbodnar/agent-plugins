/**
 * agents / ai-demos-remote-mcp-github-oauth
 *
 * Source page: Push notifications
 * Docs subpath: docs/agents/guides/remote-mcp-server.mdx
 * Template: cloudflare/ai/demos/remote-mcp-github-oauth
 * Default target dir: my-mcp-server-github-auth
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-mcp-server-github-auth --template=cloudflare/ai/demos/remote-mcp-github-oauth
 *   [yarn] yarn create cloudflare my-mcp-server-github-auth --template=cloudflare/ai/demos/remote-mcp-github-oauth
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli agents ai-demos-remote-mcp-github-oauth           # print
 *   ./scripts/cli agents ai-demos-remote-mcp-github-oauth --run     # execute
 *   ./scripts/cli agents ai-demos-remote-mcp-github-oauth --json    # metadata
 *   ./scripts/cli agents ai-demos-remote-mcp-github-oauth --target-dir=my-project
 *
...
export const meta = {
  product: "agents",
  subcommand: "ai-demos-remote-mcp-github-oauth",
  description: "For a step-by-step deployment guide, refer to [Secure MCP servers with Access for SaaS](https://developers.cloudflare.com/cloudflare-one/access-controls/ai-controls/secure-mcp-servers/).",
  page_title: "Push notifications",
  template_id: "cloudflare/ai/demos/remote-mcp-github-oauth",
  target_dir: "my-mcp-server-github-auth",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-mcp-server-github-auth --template=cloudflare/ai/demos/remote-mcp-github-oauth",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-mcp-server-github-auth --template=cloudflare/ai/demos/remote-mcp-github-oauth"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-mcp-server-github-auth --template=cloudflare/ai/demos/remote-mcp-github-oauth"
    }
  ],
} as const;
