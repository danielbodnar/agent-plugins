 ...
 * agents / my-chess-app
 *
 * Source page: Build a voice agent
 * Docs subpath: docs/agents/guides/chatgpt-app.mdx
 * Default target dir: my-chess-app
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-chess-app
 *   [yarn] yarn create cloudflare my-chess-app
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli agents my-chess-app           # print
 *   ./scripts/cli agents my-chess-app --run     # execute
 *   ./scripts/cli agents my-chess-app --json    # metadata
 *   ./scripts/cli agents my-chess-app --target-dir=my-project
 *
...
export const meta = {
  product: "agents",
  subcommand: "my-chess-app",
  description: "To use ChatGPT Apps (also called connectors), you need to enable developer mode:",
  page_title: "Build a voice agent",
  template_id: null,
  target_dir: "my-chess-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-chess-app",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-chess-app"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-chess-app"
    }
  ],
} as const;
