 ...
 * agents / chat-agent
 *
 * Source page: Add to existing project
 * Docs subpath: docs/agents/getting-started/build-a-chat-agent.mdx
 * Default target dir: chat-agent
 *
 *
 * Primary command:
 ...
 *   ./scripts/cli agents chat-agent           # print
 *   ./scripts/cli agents chat-agent --run     # execute
 *   ./scripts/cli agents chat-agent --json    # metadata
 *   ./scripts/cli agents chat-agent --target-dir=my-project
 *
...
export const meta = {
  product: "agents",
  subcommand: "chat-agent",
  description: "",
  page_title: "Add to existing project",
  template_id: null,
  target_dir: "chat-agent",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest chat-agent",
  alternates: [],
} as const;
