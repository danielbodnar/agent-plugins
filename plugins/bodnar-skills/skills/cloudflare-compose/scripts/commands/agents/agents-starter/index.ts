/**
 * agents / agents-starter
 *
 * Source page: Build Agents on Cloudflare
 * Docs subpath: docs/agents/getting-started/quick-start.mdx
 ...
 *
 * Alternate runtimes:
 *   [npm] npm create cloudflare@latest voice-agent -- --template cloudflare/agents-starter
 *   [pnpm] pnpm create cloudflare@latest --template cloudflare/agents-starter
 *   [yarn] yarn create cloudflare --template cloudflare/agents-starter
 *   [npx] npx create-cloudflare@latest --template cloudflare/agents-starter
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli agents agents-starter           # print
 *   ./scripts/cli agents agents-starter --run     # execute
 *   ./scripts/cli agents agents-starter --json    # metadata
 *   ./scripts/cli agents agents-starter --target-dir=my-project
 *
...
export const meta = {
  product: "agents",
  subcommand: "agents-starter",
  description: "Build AI agents that persist, think, and act. Agents run on Cloudflare's global network, maintain state across requests, and connect to clients in real-time via WebSockets.",
  page_title: "Build Agents on Cloudflare",
  template_id: "cloudflare/agents-starter",
  target_dir: null,
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- --template cloudflare/agents-starter",
  alternates: [
    {
      "runtime": "npm",
      "command": "npm create cloudflare@latest voice-agent -- --template cloudflare/agents-starter"
    },
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest --template cloudflare/agents-starter"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare --template cloudflare/agents-starter"
    },
    {
      "runtime": "npx",
      "command": "npx create-cloudflare@latest --template cloudflare/agents-starter"
    }
  ],
} as const;
