 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest remote-mcp-server-authless --template=cloudflare/ai/demos/remote-mcp-authless
 *   [yarn] yarn create cloudflare remote-mcp-server-authless --template=cloudflare/ai/demos/remote-mcp-authless
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli agents ai-demos-remote-mcp-authless           # print
 *   ./scripts/cli agents ai-demos-remote-mcp-authless --run     # execute
 *   ./scripts/cli agents ai-demos-remote-mcp-authless --json    # metadata
 *   ./scripts/cli agents ai-demos-remote-mcp-authless --target-dir=my-project
 *
...
export const meta = {
  product: "agents",
  subcommand: "ai-demos-remote-mcp-authless",
  description: "The button below will guide you through everything you need to do to deploy an [example MCP server ↗](https://github.com/cloudflare/ai/tree/main/demos/remote-mcp-authless) to your Cloudflare account:",
  page_title: "Push notifications",
  template_id: "cloudflare/ai/demos/remote-mcp-authless",
  target_dir: "remote-mcp-server-authless",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- remote-mcp-server-authless --template=cloudflare/ai/demos/remote-mcp-authless",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest remote-mcp-server-authless --template=cloudflare/ai/demos/remote-mcp-authless"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare remote-mcp-server-authless --template=cloudflare/ai/demos/remote-mcp-authless"
    }
  ],
} as const;
