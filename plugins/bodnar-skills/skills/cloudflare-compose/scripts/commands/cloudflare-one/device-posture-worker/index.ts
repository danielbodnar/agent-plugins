/**
 * cloudflare-one / device-posture-worker
 *
 * Source page: Isolate risky Entra ID users
 * Docs subpath: docs/cloudflare-one/tutorials/extend-sso-with-workers.mdx
 * Default target dir: device-posture-worker
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest device-posture-worker
 *   [yarn] yarn create cloudflare device-posture-worker
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli cloudflare-one device-posture-worker           # print
 *   ./scripts/cli cloudflare-one device-posture-worker --run     # execute
 *   ./scripts/cli cloudflare-one device-posture-worker --json    # metadata
 *   ./scripts/cli cloudflare-one device-posture-worker --target-dir=my-project
 *
...
export const meta = {
  ...
  subcommand: "device-posture-worker",
  description: "",
  page_title: "Isolate risky Entra ID users",
  template_id: null,
  target_dir: "device-posture-worker",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- device-posture-worker",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest device-posture-worker"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare device-posture-worker"
    }
  ],
} as const;
