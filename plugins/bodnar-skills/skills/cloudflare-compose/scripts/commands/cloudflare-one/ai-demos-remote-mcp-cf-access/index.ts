/**
 * cloudflare-one / ai-demos-remote-mcp-cf-access
 *
 ...
 * Default target dir: mcp-server-cf-access
 *
 ...
 *   ./scripts/cli cloudflare-one ai-demos-remote-mcp-cf-access           # print
 *   ./scripts/cli cloudflare-one ai-demos-remote-mcp-cf-access --run     # execute
 *   ./scripts/cli cloudflare-one ai-demos-remote-mcp-cf-access --json    # metadata
 *   ./scripts/cli cloudflare-one ai-demos-remote-mcp-cf-access --target-dir=my-project
 *
...
export const meta = {
  ...
  subcommand: "ai-demos-remote-mcp-cf-access",
  description: "We will configure `ACCESS_CLIENT_ID` and the other secret values in a later step.",
  page_title: "Secure MCP servers",
  template_id: "cloudflare/ai/demos/remote-mcp-cf-access",
  target_dir: "mcp-server-cf-access",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- mcp-server-cf-access --template=cloudflare/ai/demos/remote-mcp-cf-access",
  alternates: [],
} as const;
