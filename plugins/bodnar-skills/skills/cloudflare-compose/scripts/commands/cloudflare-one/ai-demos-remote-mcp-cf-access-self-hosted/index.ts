/**
 * cloudflare-one / ai-demos-remote-mcp-cf-access-self-hosted
 *
 * Source page: Secure MCP servers
 * Docs subpath: docs/cloudflare-one/access-controls/ai-controls/secure-mcp-servers.mdx
 * Template: cloudflare/ai/demos/remote-mcp-cf-access-self-hosted
 * Default target dir: mcp-access-self-hosted
 *
 ...
 *   ./scripts/cli cloudflare-one ai-demos-remote-mcp-cf-access-self-hosted           # print
 *   ./scripts/cli cloudflare-one ai-demos-remote-mcp-cf-access-self-hosted --run     # execute
 *   ./scripts/cli cloudflare-one ai-demos-remote-mcp-cf-access-self-hosted --json    # metadata
 *   ./scripts/cli cloudflare-one ai-demos-remote-mcp-cf-access-self-hosted --target-dir=my-project
 *
...
export const meta = {
  ...
  subcommand: "ai-demos-remote-mcp-cf-access-self-hosted",
  description: "We will configure `TEAM_DOMAIN` and `POLICY_AUD` in a later step.",
  page_title: "Secure MCP servers",
  template_id: "cloudflare/ai/demos/remote-mcp-cf-access-self-hosted",
  target_dir: "mcp-access-self-hosted",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- mcp-access-self-hosted --template=cloudflare/ai/demos/remote-mcp-cf-access-self-hosted",
  alternates: [],
} as const;
