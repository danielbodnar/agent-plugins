/**
 * cloudflare-one / https-github-com-cloudflare-workers-access-external-auth-example
 *
 * Source page: Application paths
 * Docs subpath: docs/cloudflare-one/access-controls/policies/external-evaluation.mdx
 * Template: https://github.com/cloudflare/workers-access-external-auth-example
 * Default target dir: my-worker
 *
 *
 * Primary command:
 ...
 *   ./scripts/cli cloudflare-one https-github-com-cloudflare-workers-access-external-auth-example           # print
 *   ./scripts/cli cloudflare-one https-github-com-cloudflare-workers-access-external-auth-example --run     # execute
 *   ./scripts/cli cloudflare-one https-github-com-cloudflare-workers-access-external-auth-example --json    # metadata
 *   ./scripts/cli cloudflare-one https-github-com-cloudflare-workers-access-external-auth-example --target-dir=my-project
 *
...
export const meta = {
  ...
  subcommand: "https-github-com-cloudflare-workers-access-external-auth-example",
  description: "",
  page_title: "Application paths",
  template_id: "https://github.com/cloudflare/workers-access-external-auth-example",
  target_dir: "my-worker",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest my-worker -- --template https://github.com/cloudflare/workers-access-external-auth-example",
  alternates: [],
} as const;
