/**
 * stream / stream-webhook-handler
 *
 * Source page: Test webhooks locally
 * Docs subpath: docs/stream/examples/test-webhooks-locally.mdx
 * Default target dir: stream-webhook-handler
 *
 ...
 *   ./scripts/cli stream stream-webhook-handler           # print
 *   ./scripts/cli stream stream-webhook-handler --run     # execute
 *   ./scripts/cli stream stream-webhook-handler --json    # metadata
 *   ./scripts/cli stream stream-webhook-handler --target-dir=my-project
 *
...
export const meta = {
  product: "stream",
  subcommand: "stream-webhook-handler",
  description: "Create a new Worker project that will receive webhook requests:",
  page_title: "Test webhooks locally",
  template_id: null,
  target_dir: "stream-webhook-handler",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest stream-webhook-handler",
  alternates: [],
} as const;
