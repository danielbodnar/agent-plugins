 ...
 * d1 / d1-http
 *
 * Source page: Build a Staff Directory Application
 * Docs subpath: docs/d1/tutorials/build-an-api-to-access-d1.mdx
 * Default target dir: d1-http
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest d1-http
 *   [yarn] yarn create cloudflare d1-http
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli d1 d1-http           # print
 *   ./scripts/cli d1 d1-http --run     # execute
 *   ./scripts/cli d1 d1-http --json    # metadata
 *   ./scripts/cli d1 d1-http --target-dir=my-project
 *
...
export const meta = {
  ...
  subcommand: "d1-http",
  description: "",
  page_title: "Build a Staff Directory Application",
  template_id: null,
  target_dir: "d1-http",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- d1-http",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest d1-http"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare d1-http"
    }
  ],
} as const;
