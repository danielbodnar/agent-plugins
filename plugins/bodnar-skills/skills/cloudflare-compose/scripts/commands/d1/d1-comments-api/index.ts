 ...
 * Docs subpath: docs/d1/tutorials/build-a-comments-api.mdx
 * Default target dir: d1-comments-api
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest d1-comments-api
 *   [yarn] yarn create cloudflare d1-comments-api
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli d1 d1-comments-api           # print
 *   ./scripts/cli d1 d1-comments-api --run     # execute
 *   ./scripts/cli d1 d1-comments-api --json    # metadata
 *   ./scripts/cli d1 d1-comments-api --target-dir=my-project
 *
...
export const meta = {
  product: "d1",
  subcommand: "d1-comments-api",
  description: "",
  page_title: "Tutorials",
  template_id: null,
  target_dir: "d1-comments-api",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- d1-comments-api",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest d1-comments-api"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare d1-comments-api"
    }
  ],
} as const;
