 ...
 *
 * Source page: Pricing
 * Docs subpath: docs/d1/get-started.mdx
 * Default target dir: d1-tutorial
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest d1-tutorial
 *   [yarn] yarn create cloudflare d1-tutorial
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli d1 d1-tutorial           # print
 *   ./scripts/cli d1 d1-tutorial --run     # execute
 *   ./scripts/cli d1 d1-tutorial --json    # metadata
 *   ./scripts/cli d1 d1-tutorial --target-dir=my-project
 *
...
export const meta = {
  product: "d1",
  subcommand: "d1-tutorial",
  description: "",
  page_title: "Pricing",
  template_id: null,
  target_dir: "d1-tutorial",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- d1-tutorial",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest d1-tutorial"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare d1-tutorial"
    }
  ],
} as const;
