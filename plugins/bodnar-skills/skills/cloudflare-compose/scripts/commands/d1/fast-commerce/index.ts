 ...
 * d1 / fast-commerce
 *
 * Source page: Using D1 Read Replication for your e-commerce website
 * Docs subpath: docs/d1/tutorials/using-read-replication-for-e-com.mdx
 * Default target dir: fast-commerce
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest fast-commerce
 *   [yarn] yarn create cloudflare fast-commerce
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli d1 fast-commerce           # print
 *   ./scripts/cli d1 fast-commerce --run     # execute
 *   ./scripts/cli d1 fast-commerce --json    # metadata
 *   ./scripts/cli d1 fast-commerce --target-dir=my-project
 *
...
export const meta = {
  product: "d1",
  subcommand: "fast-commerce",
  description: "Create a new Workers project by running the following command:",
  page_title: "Using D1 Read Replication for your e-commerce website",
  template_id: null,
  target_dir: "fast-commerce",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- fast-commerce",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest fast-commerce"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare fast-commerce"
    }
  ],
} as const;
