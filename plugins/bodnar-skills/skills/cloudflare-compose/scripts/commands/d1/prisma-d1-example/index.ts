/**
 * d1 / prisma-d1-example
 *
 * Source page: Query D1 using Prisma ORM
 * Docs subpath: docs/d1/tutorials/d1-and-prisma-orm.mdx
 * Default target dir: prisma-d1-example
 *
 ...
 *   ./scripts/cli d1 prisma-d1-example           # print
 *   ./scripts/cli d1 prisma-d1-example --run     # execute
 *   ./scripts/cli d1 prisma-d1-example --json    # metadata
 *   ./scripts/cli d1 prisma-d1-example --target-dir=my-project
 *
...
export const meta = {
  product: "d1",
  subcommand: "prisma-d1-example",
  description: "You may wish to manually follow the steps if you are new to Cloudflare Workers.",
  page_title: "Query D1 using Prisma ORM",
  template_id: null,
  target_dir: "prisma-d1-example",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest prisma-d1-example -- --type hello-world",
  alternates: [],
} as const;
