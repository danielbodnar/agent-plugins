/**
 * pages / my-angular-app
 *
 * Source page: Analog
 * Docs subpath: docs/pages/framework-guides/deploy-an-angular-site.mdx
 * Default target dir: my-angular-app
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-angular-app --framework=angular --platform=pages
 *   [yarn] yarn create cloudflare my-angular-app --framework=angular --platform=pages
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli pages my-angular-app           # print
 *   ./scripts/cli pages my-angular-app --run     # execute
 *   ./scripts/cli pages my-angular-app --json    # metadata
 *   ./scripts/cli pages my-angular-app --target-dir=my-project
 *
...
export const meta = {
  product: "pages",
  subcommand: "my-angular-app",
  description: "[Angular ↗](https://angular.io/) is an incredibly popular framework for building reactive and powerful front-end applications.",
  page_title: "Analog",
  template_id: null,
  target_dir: "my-angular-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-angular-app --framework=angular --platform=pages",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-angular-app --framework=angular --platform=pages"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-angular-app --framework=angular --platform=pages"
    }
  ],
} as const;
