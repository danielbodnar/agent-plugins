/**
 * pages / my-docusaurus-app
 *
 * Source page: Docusaurus
 * Docs subpath: docs/pages/framework-guides/deploy-a-docusaurus-site.mdx
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-docusaurus-app --framework=docusaurus --platform=pages
 *   [yarn] yarn create cloudflare my-docusaurus-app --framework=docusaurus --platform=pages
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli pages my-docusaurus-app           # print
 *   ./scripts/cli pages my-docusaurus-app --run     # execute
 *   ./scripts/cli pages my-docusaurus-app --json    # metadata
 *   ./scripts/cli pages my-docusaurus-app --target-dir=my-project
 *
...
export const meta = {
  ...
  description: "[Docusaurus ↗](https://docusaurus.io) is a static site generator. It builds a single-page application with fast client-side navigation, leveraging the full power of React to make your site interactive. It provides out-of-the-box documentation features but can be used to create any kind of site such as a personal website, a product site, a blog, or marketing landing pages.",
  page_title: "Docusaurus",
  template_id: null,
  target_dir: "my-docusaurus-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-docusaurus-app --framework=docusaurus --platform=pages",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-docusaurus-app --framework=docusaurus --platform=pages"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-docusaurus-app --framework=docusaurus --platform=pages"
    }
  ],
} as const;
