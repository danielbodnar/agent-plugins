 ...
 *
 * Source page: Sphinx
 * Docs subpath: docs/pages/framework-guides/deploy-a-svelte-kit-site.mdx
 * Default target dir: my-svelte-app
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-svelte-app --framework=svelte --platform=pages
 *   [yarn] yarn create cloudflare my-svelte-app --framework=svelte --platform=pages
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli pages my-svelte-app           # print
 *   ./scripts/cli pages my-svelte-app --run     # execute
 *   ./scripts/cli pages my-svelte-app --json    # metadata
 *   ./scripts/cli pages my-svelte-app --target-dir=my-project
 *
...
export const meta = {
  product: "pages",
  subcommand: "my-svelte-app",
  description: "In this guide, you will create a new SvelteKit application and deploy it using Cloudflare Pages. You will use [SvelteKit ↗](https://kit.svelte.dev/), the official Svelte framework for building web applications of all sizes.",
  page_title: "Sphinx",
  template_id: null,
  target_dir: "my-svelte-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-svelte-app --framework=svelte --platform=pages",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-svelte-app --framework=svelte --platform=pages"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-svelte-app --framework=svelte --platform=pages"
    }
  ],
} as const;
