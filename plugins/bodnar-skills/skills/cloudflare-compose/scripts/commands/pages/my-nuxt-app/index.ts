 ...
 *
 * Source page: Jekyll
 * Docs subpath: docs/pages/framework-guides/deploy-a-nuxt-site.mdx
 * Default target dir: my-nuxt-app
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-nuxt-app --framework=nuxt --platform=pages
 *   [yarn] yarn create cloudflare my-nuxt-app --framework=nuxt --platform=pages
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli pages my-nuxt-app           # print
 *   ./scripts/cli pages my-nuxt-app --run     # execute
 *   ./scripts/cli pages my-nuxt-app --json    # metadata
 *   ./scripts/cli pages my-nuxt-app --target-dir=my-project
 *
...
export const meta = {
  product: "pages",
  subcommand: "my-nuxt-app",
  description: "[Nuxt ↗](https://nuxt.com) is a web framework making Vue.js-based development simple and powerful.",
  page_title: "Jekyll",
  template_id: null,
  target_dir: "my-nuxt-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-nuxt-app --framework=nuxt --platform=pages",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-nuxt-app --framework=nuxt --platform=pages"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-nuxt-app --framework=nuxt --platform=pages"
    }
  ],
} as const;
