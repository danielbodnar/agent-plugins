 ...
 * pages / i18n-example
 *
 * Source page: Localize a website with HTMLRewriter
 * Docs subpath: docs/pages/tutorials/localize-a-website.mdx
 * Default target dir: i18n-example
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest i18n-example
 *   [yarn] yarn create cloudflare i18n-example
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli pages i18n-example           # print
 *   ./scripts/cli pages i18n-example --run     # execute
 *   ./scripts/cli pages i18n-example --json    # metadata
 *   ./scripts/cli pages i18n-example --target-dir=my-project
 *
...
export const meta = {
  product: "pages",
  subcommand: "i18n-example",
  description: "Refer to the [GitHub documentation ↗](https://guides.github.com/introduction/git-handbook/) and [Git documentation ↗](https://git-scm.com/book/en/v2) for more information.",
  page_title: "Localize a website with HTMLRewriter",
  template_id: null,
  target_dir: "i18n-example",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- i18n-example",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest i18n-example"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare i18n-example"
    }
  ],
} as const;
