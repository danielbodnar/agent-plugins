 ...
 *
 * Source page: Hono
 * Docs subpath: docs/pages/framework-guides/deploy-a-hono-site.mdx
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-hono-app --framework=hono --platform=pages
 *   [yarn] yarn create cloudflare my-hono-app --framework=hono --platform=pages
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli pages my-hono-app           # print
 *   ./scripts/cli pages my-hono-app --run     # execute
 *   ./scripts/cli pages my-hono-app --json    # metadata
 *   ./scripts/cli pages my-hono-app --target-dir=my-project
 *
...
export const meta = {
  product: "pages",
  subcommand: "my-hono-app",
  description: "[Hono ↗](https://honojs.dev/) is a small, simple, and ultrafast web framework for Cloudflare Pages and Workers, Deno, and Bun. Learn more about the creation of Hono by [watching an interview](#creator-interview) with its creator, [Yusuke Wada ↗](https://yusu.ke/).",
  page_title: "Hono",
  template_id: null,
  target_dir: "my-hono-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-hono-app --framework=hono --platform=pages",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-hono-app --framework=hono --platform=pages"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-hono-app --framework=hono --platform=pages"
    }
  ],
} as const;
