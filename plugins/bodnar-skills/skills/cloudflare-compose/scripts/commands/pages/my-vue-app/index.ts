 ...
 *
 * Source page: Vue
 * Docs subpath: docs/pages/framework-guides/deploy-a-vue-site.mdx
 * Default target dir: my-vue-app
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-vue-app --framework=vue --platform=pages
 *   [yarn] yarn create cloudflare my-vue-app --framework=vue --platform=pages
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli pages my-vue-app           # print
 *   ./scripts/cli pages my-vue-app --run     # execute
 *   ./scripts/cli pages my-vue-app --json    # metadata
 *   ./scripts/cli pages my-vue-app --target-dir=my-project
 *
...
export const meta = {
  product: "pages",
  subcommand: "my-vue-app",
  description: "[Vue ↗](https://vuejs.org/) is a progressive JavaScript framework for building user interfaces. A core principle of Vue is incremental adoption: this makes it easy to build Vue applications that live side-by-side with your existing code.",
  page_title: "Vue",
  template_id: null,
  target_dir: "my-vue-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-vue-app --framework=vue --platform=pages",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-vue-app --framework=vue --platform=pages"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-vue-app --framework=vue --platform=pages"
    }
  ],
} as const;
