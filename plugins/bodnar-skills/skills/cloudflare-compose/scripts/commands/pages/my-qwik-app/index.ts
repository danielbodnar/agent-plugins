 ...
 *
 * Source page: Qwik
 * Docs subpath: docs/pages/framework-guides/deploy-a-qwik-site.mdx
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-qwik-app --framework=qwik --platform=pages
 *   [yarn] yarn create cloudflare my-qwik-app --framework=qwik --platform=pages
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli pages my-qwik-app           # print
 *   ./scripts/cli pages my-qwik-app --run     # execute
 *   ./scripts/cli pages my-qwik-app --json    # metadata
 *   ./scripts/cli pages my-qwik-app --target-dir=my-project
 *
...
export const meta = {
  ...
  description: "[Qwik ↗](https://github.com/builderio/qwik) is an open-source, DOM-centric, resumable web application framework designed for best possible time to interactive by focusing on [resumability ↗](https://qwik.builder.io/docs/concepts/resumable/), server-side rendering of HTML and [fine-grained lazy-loading ↗](https://qwik.builder.io/docs/concepts/progressive/#lazy-loading) of code.",
  page_title: "Qwik",
  template_id: null,
  target_dir: "my-qwik-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-qwik-app --framework=qwik --platform=pages",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-qwik-app --framework=qwik --platform=pages"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-qwik-app --framework=qwik --platform=pages"
    }
  ],
} as const;
