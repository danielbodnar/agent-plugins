 ...
 *
 * Source page: Remix
 * Docs subpath: docs/pages/framework-guides/deploy-a-solid-start-site.mdx
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-solid-app --framework=solid
 *   [yarn] yarn create cloudflare my-solid-app --framework=solid
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli pages my-solid-app           # print
 *   ./scripts/cli pages my-solid-app --run     # execute
 *   ./scripts/cli pages my-solid-app --json    # metadata
 *   ./scripts/cli pages my-solid-app --target-dir=my-project
 *
...
export const meta = {
  ...
  description: "[Solid ↗](https://www.solidjs.com/) is an open-source web application framework focused on generating performant applications with a modern developer experience based on JSX.",
  page_title: "Remix",
  template_id: null,
  target_dir: "my-solid-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-solid-app --framework=solid",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-solid-app --framework=solid"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-solid-app --framework=solid"
    }
  ],
} as const;
