 ...
 *
 * Source page: Astro
 * Docs subpath: docs/pages/framework-guides/deploy-an-astro-site.mdx
 * Default target dir: my-astro-app
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest my-astro-app --framework=astro --platform=pages
 *   [yarn] yarn create cloudflare my-astro-app --framework=astro --platform=pages
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli pages my-astro-app           # print
 *   ./scripts/cli pages my-astro-app --run     # execute
 *   ./scripts/cli pages my-astro-app --json    # metadata
 *   ./scripts/cli pages my-astro-app --target-dir=my-project
 *
...
export const meta = {
  product: "pages",
  subcommand: "my-astro-app",
  description: "[Astro ↗](https://astro.build) is an all-in-one web framework for building fast, content-focused websites. By default, Astro builds websites that have zero JavaScript runtime code.",
  page_title: "Astro",
  template_id: null,
  target_dir: "my-astro-app",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- my-astro-app --framework=astro --platform=pages",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest my-astro-app --framework=astro --platform=pages"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare my-astro-app --framework=astro --platform=pages"
    }
  ],
} as const;
