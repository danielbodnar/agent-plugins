/**
 * vectorize / vectorize-tutorial
 *
 * Source page: Introduction to Vectorize
 * Docs subpath: docs/vectorize/get-started/intro.mdx
 * Default target dir: vectorize-tutorial
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest vectorize-tutorial
 *   [yarn] yarn create cloudflare vectorize-tutorial
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli vectorize vectorize-tutorial           # print
 *   ./scripts/cli vectorize vectorize-tutorial --run     # execute
 *   ./scripts/cli vectorize vectorize-tutorial --json    # metadata
 *   ./scripts/cli vectorize vectorize-tutorial --target-dir=my-project
 *
...
export const meta = {
  ...
  page_title: "Introduction to Vectorize",
  template_id: null,
  target_dir: "vectorize-tutorial",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- vectorize-tutorial",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest vectorize-tutorial"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare vectorize-tutorial"
    }
  ],
} as const;
