/**
 * vectorize / embeddings-tutorial
 *
 * Source page: Query vectors
 * Docs subpath: docs/vectorize/get-started/embeddings.mdx
 * Default target dir: embeddings-tutorial
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest embeddings-tutorial
 *   [yarn] yarn create cloudflare embeddings-tutorial
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli vectorize embeddings-tutorial           # print
 *   ./scripts/cli vectorize embeddings-tutorial --run     # execute
 *   ./scripts/cli vectorize embeddings-tutorial --json    # metadata
 *   ./scripts/cli vectorize embeddings-tutorial --target-dir=my-project
 *
...
export const meta = {
  product: "vectorize",
  subcommand: "embeddings-tutorial",
  description: "You will create a new project that will contain a Worker script, which will act as the client application for your Vectorize index.",
  page_title: "Query vectors",
  template_id: null,
  target_dir: "embeddings-tutorial",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- embeddings-tutorial",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest embeddings-tutorial"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare embeddings-tutorial"
    }
  ],
} as const;
