/**
 * realtime / hello-agent
 *
 * Source page: Getting started
 * Docs subpath: docs/realtime/agents/getting-started.mdx
 * Default target dir: hello-agent
 *
 *
 * Primary command:
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest hello-agent
 *   [yarn] yarn create cloudflare hello-agent
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli realtime hello-agent           # print
 *   ./scripts/cli realtime hello-agent --run     # execute
 *   ./scripts/cli realtime hello-agent --json    # metadata
 *   ./scripts/cli realtime hello-agent --target-dir=my-project
 *
...
export const meta = {
  product: "realtime",
  subcommand: "hello-agent",
  description: "",
  page_title: "Getting started",
  template_id: null,
  target_dir: "hello-agent",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- hello-agent",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest hello-agent"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare hello-agent"
    }
  ],
} as const;
