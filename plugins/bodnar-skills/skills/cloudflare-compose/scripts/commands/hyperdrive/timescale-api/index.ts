/**
 * hyperdrive / timescale-api
 *
 * Source page: Tutorials
 * Docs subpath: docs/hyperdrive/tutorials/serverless-timeseries-api-with-timescale.mdx
 * Default target dir: timescale-api
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest timescale-api
 *   [yarn] yarn create cloudflare timescale-api
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli hyperdrive timescale-api           # print
 *   ./scripts/cli hyperdrive timescale-api --run     # execute
 *   ./scripts/cli hyperdrive timescale-api --json    # metadata
 *   ./scripts/cli hyperdrive timescale-api --target-dir=my-project
 *
...
export const meta = {
  product: "hyperdrive",
  subcommand: "timescale-api",
  description: "Run the following command to create a Worker project from the command line:",
  page_title: "Tutorials",
  template_id: null,
  target_dir: "timescale-api",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- timescale-api",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest timescale-api"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare timescale-api"
    }
  ],
} as const;
