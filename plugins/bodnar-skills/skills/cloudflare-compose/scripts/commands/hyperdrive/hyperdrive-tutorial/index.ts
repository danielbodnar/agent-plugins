/**
 * hyperdrive / hyperdrive-tutorial
 *
 * Source page: Getting started
 * Docs subpath: docs/hyperdrive/get-started.mdx
 * Default target dir: hyperdrive-tutorial
 *
 ...
 *
 * Alternate runtimes:
 *   [pnpm] pnpm create cloudflare@latest hyperdrive-tutorial
 *   [yarn] yarn create cloudflare hyperdrive-tutorial
 *
 * Invoke via the dispatcher:
 *   ./scripts/cli hyperdrive hyperdrive-tutorial           # print
 *   ./scripts/cli hyperdrive hyperdrive-tutorial --run     # execute
 *   ./scripts/cli hyperdrive hyperdrive-tutorial --json    # metadata
 *   ./scripts/cli hyperdrive hyperdrive-tutorial --target-dir=my-project
 *
...
export const meta = {
  product: "hyperdrive",
  subcommand: "hyperdrive-tutorial",
  description: "You will be directed to a web page asking you to log in to the Cloudflare dashboard. After you have logged in, you will be asked if Wrangler can make changes to your Cloudflare account. Scroll down and select **Allow** to continue.",
  page_title: "Getting started",
  template_id: null,
  target_dir: "hyperdrive-tutorial",
  primary_runtime: "npm",
  primary_command: "npm create cloudflare@latest -- hyperdrive-tutorial",
  alternates: [
    {
      "runtime": "pnpm",
      "command": "pnpm create cloudflare@latest hyperdrive-tutorial"
    },
    {
      "runtime": "yarn",
      "command": "yarn create cloudflare hyperdrive-tutorial"
    }
  ],
} as const;
